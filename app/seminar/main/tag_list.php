...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/seminar/seminar_tag_list.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/seminar/headerSub_layout_sem_tagli_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/seminar/list/body_taglist_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

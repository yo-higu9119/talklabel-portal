...
<body class="sem_det_list fontFace">
...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/seminar/headerSub_layout_sem_detli_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/seminar/list/body_detlist_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

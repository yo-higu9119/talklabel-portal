...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/product/product.php';
...
<?php require dirname(__FILE__).'/../../core_sys/inc/sys/product/product_cart_js.php';?>
</head>

<body class="prd_det fontFace">
...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/product/headerSub_layout_prd_det_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/product/main/body_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/seminar/seminar_cart.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/seminar/body_semcart_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

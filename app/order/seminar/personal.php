...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/seminar/seminar_personal.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/seminar/body_sempersonal_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

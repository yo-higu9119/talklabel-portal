...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/product/product_finalsave.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/product/body_prdsave_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

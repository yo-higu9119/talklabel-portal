...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/product/product_cart.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../core_sys/inc/sys/product/delivery_buy_js.php';?>
</head>
...
<input type="hidden" name="page_disp_num" value="5" id="page_disp_num">
<input type="hidden" name="disp_max" value="30" id="disp_max">
<input type="hidden" name="group_id" value="1" id="group_id">
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/product/body_prdcart_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

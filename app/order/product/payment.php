...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/product/product_payment.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../core_sys/inc/sys/payment/pay_input_payment_product_js.php';?>
</head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/product/body_payment_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/product/product_address.php';
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/product/prdadd_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/service/service_finalcheck.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/order/service/body_svcheck_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

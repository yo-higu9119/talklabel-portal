...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/contents/contents_tag_list.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/contents/headerSub_layout_con_tagli_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/contents/list/body_taglist_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/contents/headerSub_layout_con_li_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/contents/list/body_list_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

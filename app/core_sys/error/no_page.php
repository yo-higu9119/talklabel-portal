...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/error/headerSub_layout_nopage.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/error/no_page/body_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

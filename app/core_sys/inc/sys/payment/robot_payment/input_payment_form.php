...
?>
									<section class="InputForm">
										...
										<dl class="clear_fix">
											...
											<dd>
												<p><span>名</span><input type="text" inputtype="email" name="ln" size="10" value="" maxlength="100" class="txt size220 ln" style="text-transform: uppercase;"  placeholder="<?php echo Util::dispLang(Language::WORD_00240);/*ローマ字で入力してください*/?>"  required />　<span>姓</span><input type="text" inputtype="email" name="fn" size="10" value="" maxlength="100" class="txt size220 fn" style="text-transform: uppercase;"  placeholder="<?php echo Util::dispLang(Language::WORD_00240);/*ローマ字で入力してください*/?>"  required /></p>
												<hr class="hiddenborder" style="transform: scaleX(0);">
											</dd>
										</dl>
										<dl class="clear_fix">

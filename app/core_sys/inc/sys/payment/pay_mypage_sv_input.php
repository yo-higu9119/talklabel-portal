...
<?php require dirname(__FILE__).'/./pay_bank_tag.php';?>
						...
						<div class="BtM flexBtM clear_fix">
							<p><button type="button" class="sbmBNBt back" onclick="$('#payment-form1').attr('action', 'sv_input.php');$('#payment-form1').submit();" /><?php echo Util::dispLang(Language::WORD_00064);/*前の画面に戻る*/?></button></p>
							<p><button type="button" class="sbmNxBt next" onclick="$('#payment-form1').attr('action', 'sv_input_check.php');$('#payment-form1').submit();" /><?php echo Util::dispLang(Language::WORD_00262);/*最終確認へ進む*/?></button></p>
						</div>
					</section>
					</form>
				</div>
...
<?php require dirname(__FILE__).'/./pay_loader.php';?>
						...
						<div class="BtM flexBtM clear_fix">
							<p><button type="button" class="sbmBNBt back" onclick="$('#payment-form2').attr('action', 'sv_input.php');$('#payment-form2').submit();" /><?php echo Util::dispLang(Language::WORD_00064);/*前の画面に戻る*/?></button></p>

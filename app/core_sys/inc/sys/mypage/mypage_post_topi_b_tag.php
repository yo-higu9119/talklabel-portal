...
<?php
	if(count($boardEmpathyList) == 0){
?>
							<p class="Art cnt mgt20 mgb10"><?php echo Util::dispLang(Language::WORD_00491);/*あなたがいいねした掲示板トピックスはありません。*/?></p>
<?php
	}else{
?>
...
<?php
		foreach ($boardEmpathyList as $key => $val){
?>
								<tr>

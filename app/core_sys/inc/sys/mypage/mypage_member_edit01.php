...
?>
									<div id="file_view<?php echo $funcInfo->id;?>"<?php echo $display_view;?>>
										...
										<div class="fileDelBT"><a href="javascript:void(0);" id="file_del<?php echo $funcInfo->id;?>" class="file_del"><?php echo Util::dispLang(Language::WORD_00629);/*ファイル削除*/?></a></div>
									</div>
									<div id="file_up<?php echo $funcInfo->id;?>" class="fileUpBT"<?php echo $display_up;?>>

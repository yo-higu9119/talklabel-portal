						<div class="TableBox">
<?php
	if(count($boardCommentList) == 0){
?>
							<p class="Art cnt mgt20 mgb10"><?php echo Util::dispLang(Language::WORD_00501);/*あなたが投稿した掲示板コメントはありません。*/?></p>
<?php
	}else{
?>
...
<?php
		foreach ($boardCommentList as $key => $val){

...
?>
	<section class="mypageOrdBoxInn">
		<dl>
			<dt><?php echo Util::dispLang(Language::WORD_00375);/*選択済みセミナー*/?></dt>
...
?></dd>
		...
		<dl>
			<dt><?php echo Util::dispLang(Language::WORD_00332);/*状況*/?></dt>
			<dd><?php echo HtmlPartsSeminar::getAcceptStatusIconStr($seminarInfo,'MdIcBg')?></dd>
		</dl>
	</section>

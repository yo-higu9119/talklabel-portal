						<div class="TableBox">
<?php
	if(count($articleCommentEmpathyList) == 0){
?>
							<p class="Art cnt mgt20 mgb10"><?php echo Util::dispLang(Language::WORD_00510);/*あなたが共感したコンテンツコメントはありません。*/?></p>
<?php
	}else{
?>
...
<?php
		foreach ($articleCommentEmpathyList as $key => $val){

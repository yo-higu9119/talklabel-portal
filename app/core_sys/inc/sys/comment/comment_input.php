...
?>
							<p class="commentForm">
								<textarea name="input_comment0" cols="50" rows="5" class="txt size100p" placeholder="<?php echo Util::dispLang(Language::WORD_00019);/* コメントを入力してください */?>"></textarea>
							</p>
						</div>
						<div class="clear_fix">
							<p class="commentBT BtM">
								<button type="button" class="commentRegBt" onclick="comment_check(0);"><?php echo Util::dispLang(Language::WORD_00020);/* コメントする */?></button>
							</p>
						</div>

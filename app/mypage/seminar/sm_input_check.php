...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sm_input_check.php';
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/seminar/mysminputcheck_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

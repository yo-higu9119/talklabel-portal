...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sm_input.php';
...
<form method="post" action="sm_input_payment.php" id="input-form">
<input type="hidden" name="si" value="<?php echo $seminarInfo->id; ?>" />
<!-- WRAPPER -->
<div id="wrapper">
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/seminar/mysminput_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sm_cancel.php';
...
<form method="post" action="sm_cancel_save.php">
<input type="hidden" name="id" value="<?php echo $seminarApplicantInfo->id; ?>" />
<!-- WRAPPER -->
<div id="wrapper">
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/seminar/mysmcan_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_prof.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<div id="main" class="clear_fix">
	<div class="main_ti clear_fix">
		<h2 class="bsc_ti"><span>プロフィールの編集</span></h2>
	</div>
	<div class="mypage_Box clear_fix">
		<div class="mainClnS">
<?php require dirname(__FILE__).'/../../system_parts/system_block/mypage/prof/mypage_prof.php';?>
		</div>

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_aff_sys.php';
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/affiliate/myaff_layout.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

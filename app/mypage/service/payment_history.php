...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sv_payment_history.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/service/mysvpayhistory_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sv_change.php';
...
<?php require dirname(__FILE__).'/../../core_sys/inc/sys/payment/pay_change_js.php';?>
</head>

<body class="popup fontFace">
<form method="post" action="sv_change_payment.php">
<input type="hidden" name="id" value="<?php echo $itemId; ?>">
<!-- WRAPPER -->
<div id="wrapper">
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/service/mysvchange_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sv_input.php';
...
<form method="post" action="sv_input_payment.php">
<input type="hidden" name="id" value="<?php echo $itemId; ?>">
<!-- WRAPPER -->
<div id="wrapper">
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/service/mysvinput_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

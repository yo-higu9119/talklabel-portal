...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/mypage/mypage_sv_change_save.php';
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/service/mysvchangesave_layout.php';?>
	</div>
<!-- CONTENTS -->
</div>
<!-- WRAPPER -->

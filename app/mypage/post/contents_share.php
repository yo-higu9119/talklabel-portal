...
$articleRespondData = new ArticleRespondData($session->getMemberName());

$searchInfoList = array();
$searchInfoList['search_member_id'] = $session->getMemberId();
$articleRespondList = $articleRespondData->getInfoList($searchInfoList,1);
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/post/mypostshare_layout.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

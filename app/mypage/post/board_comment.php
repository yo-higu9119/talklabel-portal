...
$boardCommentList = $boardCommentData->getInfoList($searchInfoList,1);

$searchInfoList = array();
$searchInfoList['search_x_my_empathy_member_id'] = $session->getMemberId();
$searchInfoList['search_not_status'] = 2;
$boardCommenEmpathyList = $boardCommentData->getInfoList($searchInfoList,1);
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/post/mypostbrdcom_layout.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

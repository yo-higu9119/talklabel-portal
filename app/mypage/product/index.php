...
$list = $productPackageData->getInfoList($searchInfoList, 1);
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<!-- HEAD -->
<!-- HEAD SUB -->
<?php require dirname(__FILE__).'/../../system_parts/layout_block/headerSub/mypage/headerSub_layout_myprd_001.php';?>
<!-- HEAD SUB -->
<!-- CONTENTS -->
	<div id="contents" class="clear_fix">
<?php require dirname(__FILE__).'/../../system_parts/layout_block/mypage/product/myprd_layout.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER SUB -->

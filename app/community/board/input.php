...
require_once dirname(__FILE__).'/../../core_sys/inc/sys/board/board_input.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
...
<?php require dirname(__FILE__).'/../../system_parts/layout_block/board/main/body_input_layout_001.php';?>
	</div>
<!-- CONTENTS -->
<!-- FOOTER -->

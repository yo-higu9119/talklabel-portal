...
<link href="<?php echo SYSTEM_TOP_URL; ?>core_sys/common/css/slider-pro/slider-pro.css<?php echo SYSTEM_ACCESS_DATETIME; ?>" rel="stylesheet">
...
<link href="<?php echo SYSTEM_TOP_URL; ?>core_sys/common/css/sys_dez.css<?php echo SYSTEM_ACCESS_DATETIME; ?>" rel="stylesheet">
...
<link href="<?php echo SYSTEM_TOP_URL; ?>css/pc/tmp_parts.css<?php echo SYSTEM_ACCESS_DATETIME; ?>" rel="stylesheet">
<link href="<?php echo SYSTEM_TOP_URL; ?>css/pc/user_parts.css<?php echo SYSTEM_ACCESS_DATETIME; ?>" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo SYSTEM_TOP_URL; ?>core_sys/common/js/jquery.sliderPro.min.js"></script>

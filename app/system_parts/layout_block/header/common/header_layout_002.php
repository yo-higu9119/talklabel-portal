...
<?php require dirname(__FILE__).'/../../../dez_block/bgheader_sp.php';?>
<?php } else { ?>
	<header id="header" class="headDez001">
		<section class="scroll-nml fadebox">
...
<?php require dirname(__FILE__).'/../../../dez_block/bgheader.php';?>
				</div>
			</div>
		</section>

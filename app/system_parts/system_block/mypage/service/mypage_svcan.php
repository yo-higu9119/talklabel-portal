			<div class="main_ti clear_fix">
				<h1 class="bsc_ti"><span><?php echo Util::dispLang(Language::WORD_00342);/*購入済みサービスのキャンセル*/?></span></h1>
			</div>
			<div class="popup_Box">
				<section class="ordDetBox">
<?php require dirname(__FILE__).'/../../../../core_sys/inc/sys/mypage/mypage_sv_cancel_detail.php';?>
				</section>
				<section class="CautTxt cnt mgt20">
					<p><?php echo Util::dispLang(Language::WORD_00343);/*上記サービスをキャンセルしても問題ありませんか？*/?><br class="pc_only" />

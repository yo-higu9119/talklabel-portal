<?php if (IS_SMART_PHONE) { ?>
						<nav class="catenavSl">
							<ul class="clear_fix">
								<li><a href="./"><?php echo Util::dispLang(Language::WORD_00486);/*トピックス*/?></a></li>
								...
								<li class="crt"><a href="./contents_comment.php"><?php echo Util::dispLang(Language::WORD_00488);/*コメント*/?></a></li>
							</ul>
						</nav>
<?php } else { ?>
<?php } ?>
...
<?php } else { ?>
						<nav class="catenavY WidW">
							<ul class="ct4 clear_fix">
								...
								<li><a href="./contents_share.php"><?php echo Util::dispLang(Language::WORD_00484);/*コンテンツいいね*/?></a></li>
								<li><a href="./contents_comment.php" class="crt"><?php echo Util::dispLang(Language::WORD_00485);/*コンテンツコメント*/?></a></li>
							</ul>
						</nav>
<?php } ?>
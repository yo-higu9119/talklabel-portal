<?php if (IS_SMART_PHONE) { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00404);/* 購入者 */?></p></li>
					<li><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00406);/* 配送先 */?></p></li>
...
<?php } else { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00403);/* 購入者情報 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00223);/* 必要事項を入力してください */?></p></li>
					<li><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00405);/* 配送先情報 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00223);/* 必要事項を入力してください */?></p></li>
<?php if($total_amount > 0){ ?>

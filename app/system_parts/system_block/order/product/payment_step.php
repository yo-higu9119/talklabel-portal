<?php if (IS_SMART_PHONE) { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00408);/* 決済 */?></p></li>
...
<?php } else { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00407);/* 決済情報 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00223);/* 必要事項を入力してください */?></p></li>

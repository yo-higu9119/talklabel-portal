...
<?php } ?>
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00412);/* 完了 */?></p></li>
				</ul>
			</div>
<?php } else { ?>
			<div class="step_flow ">
...
<?php } ?>
					...
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00411);/* 購入完了 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00415);/* 購入完了しました */?></p></li>
				</ul>
			</div>
<?php } ?>

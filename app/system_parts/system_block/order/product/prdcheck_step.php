...
<?php } ?>
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00410);/* 確認 */?></p></li>
...
<?php } ?>
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00409);/* 最終確認 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00414);/* 購入内容を確認してください */?></p></li>

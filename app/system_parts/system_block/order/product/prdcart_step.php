<?php if (IS_SMART_PHONE) { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00402);/* 選択 */?></p></li>
...
<?php } else { ?>
			<div class="step_flow ">
				<ul class="clear_fix">
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00401);/* 商品選択 */?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00413);/* 商品を選択してください */?></p></li>

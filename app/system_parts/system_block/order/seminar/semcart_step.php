			<div class="step_flow ">
				<ul class="clear_fix">
					<li class="crt"><p class="flow_ti"><?php echo Util::dispLang(Language::WORD_00217);/*選択内容*/?></p><p class="flow_com"><?php echo Util::dispLang(Language::WORD_00222);/*内容をご確認ください*/?></p></li>

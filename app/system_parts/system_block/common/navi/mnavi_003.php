			<div class="memberAraType03">
				<nav class="mnavi clear_fix">
					<ul class="mnaviInn clear_fix">
<?php
if($session->isLogin()) {
?>
						<li class="mem_mypage"><a href="<?php echo SYSTEM_TOP_URL; ?>order/product/cart.php" id="cart_bt_header"><?php echo Util::dispLang(Language::WORD_00118);/*カート*/?><?php echo $session->getCartNum(); ?></a></li>
